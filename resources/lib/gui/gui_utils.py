...
def title_with_color(label, year=None, colorname=Colors.MEDIUMSLATEBLUE):
...
def colorize(string, colorname=Colors.MEDIUMSLATEBLUE):
...
def bold(string):
    """Return string formated with bold.
